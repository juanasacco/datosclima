...
archivo_NH0472 <- "data_raw/estacion_NH0472.csv"
archivo_NH0910 <- "data_raw/estacion_NH0910.csv"
archivo_NH0046 <- "data_raw/estacion_NH0046.csv"
archivo_NH0098 <- "data_raw/estacion_NH0098.csv"
archivo_NH0437 <- "data_raw/estacion_NH0437.csv"
...
estacion_NH0472 <- readr::read_csv("data_raw/estacion_NH0472.csv")
estacion_NH0910 <- readr::read_csv("data_raw/estacion_NH0910.csv")
estacion_NH0046 <- readr::read_csv("data_raw/estacion_NH0046.csv")
estacion_NH0098 <- readr::read_csv("data_raw/estacion_NH0098.csv")
estacion_NH0437 <- readr::read_csv("data_raw/estacion_NH0437.csv")

datos_estaciones <- rbind(estacion_NH0472, estacion_NH0910, estacion_NH0046, estacion_NH0098,estacion_NH0437)
